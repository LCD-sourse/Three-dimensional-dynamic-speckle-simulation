# Three-dimensional-dynamic-speckle-simulation
Three-dimensional dynamic speckle simulation based on Monte Carlo dynamic electric field modeling and Ornstein–Uhlenbeck modeling
